-- =====================================================================
-- MEJORAS v8: el reparto usa el IVA soportado SOLO de gastos deducibles.
-- (Tras sincronizar el flag "deducible" desde el Excel, ya es fiable.)
-- Solo redefine el IVA soportado (sivasop/eivasop) respecto a v6.
-- =====================================================================
